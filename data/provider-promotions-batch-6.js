(() => {
  ...
  const promotions=[
    ...
    },
    {
      ...
      verified:checked,
      notes:"The clinic's official English site describes an international dental office in Tokyo and identifies three US-licensed dentists. Tokyo Metropolitan Government's foreign-patient list also lists English for the clinic. The reviewed provider page does not explicitly separate doctor English from reception English or establish Visitor/Resident eligibility, interpreter, insurance, self-pay or referral rules, so those fields remain unknown.",
